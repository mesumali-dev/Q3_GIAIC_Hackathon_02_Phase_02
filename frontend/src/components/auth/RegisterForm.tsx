          ...
          <div>
            ...
            <div className="relative">
              ...
              <input
                ...
                disabled={isLoading}
                className={`w-full pl-12 pr-4 py-3.5 bg-gray-50/50 border-2 rounded-2xl text-gray-900 placeholder-gray-400 focus:outline-none focus:bg-white focus:border-orange-400 focus:ring-4 focus:ring-orange-100 transition-all ${
                  errors.name
